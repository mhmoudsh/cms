<div class="sidebar p-2 py-md-3 dark">
    <div class="container-fluid">
      ...
      <div class="main-menu flex-grow-1">
        <ul class="menu-list">
          <li class="divider py-2 lh-sm"><span class="small">MAIN</span><br> <small class="text-muted">Main </small></li>
          <li>
          ...
          <li class="collapsed">
            ...
            <ul class="sub-menu collapse" id="menu_dashboard">
              <li><a class="ms-link" href="crm/index.html">Course Management</a></li>
            </ul>
          </li>
