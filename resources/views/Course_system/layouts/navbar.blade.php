                        ...
                        <ul class="list-unstyled list mb-0">
                          <li class="py-2 mb-1 border-bottom">
                            <a href="javascript:void(0);" class="d-flex">
                              <img class="avatar rounded-circle" src="assets/img/xs/avatar5.jpg.png" alt="">
                          ...
                          <li class="py-2 mb-1 border-bottom">
                            <a href="javascript:void(0);" class="d-flex">
                              <img class="avatar rounded-circle" src="assets/img/xs/avatar6.jpg.png" alt="">
                              <div class="flex-fill ms-3">
                          ...
                          <li class="py-2 mb-1 border-bottom">
                            <a href="javascript:void(0);" class="d-flex">
                              <img class="avatar rounded-circle" src="assets/img/xs/avatar1.jpg.png" alt="">
                              <div class="flex-fill ms-3">
                          ...
                          <li class="py-2 mb-1 border-bottom">
                            <a href="javascript:void(0);" class="d-flex">
                              <img class="avatar rounded-circle" src="assets/img/xs/avatar3.jpg.png" alt="">
                              <div class="flex-fill ms-3">
                          ...
                          <li class="py-2 mb-1 border-bottom">
                            <a href="javascript:void(0);" class="d-flex">
                              <img class="avatar rounded-circle" src="assets/img/xs/avatar4.jpg.png" alt="">
                              <div class="flex-fill ms-3">
                          ...
                          <li class="py-2">
                            <a href="javascript:void(0);" class="d-flex">
                              <img class="avatar rounded-circle" src="assets/img/xs/avatar7.jpg.png" alt="">
                              <div class="flex-fill ms-3">
                  ...
                  <div class="card border-0 w240">
                    <div class="card-body border-bottom d-flex">
                      ...
                      <div class="flex-fill ms-3">
                        ...
                        <span class="text-muted"><a href="../../cdn-cgi/l/email-protection.html" class="__cf_email__"
                            data-cfemail="1c7d707075797b6e7d68796e5c70697273327f7371">[email&#160;protected]</a></span>
                      </div>
                    </div>
                    <div class="list-group m-2 mb-3">
                      ...
                      <a class="list-group-item list-group-item-action border-0"
                        href="https://www.wrraptheme.com/templates/luno/dashboard-enevt.html"><i
